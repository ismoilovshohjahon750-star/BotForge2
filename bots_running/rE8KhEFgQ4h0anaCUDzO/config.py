...
SOAT_UPDATE_INTERVAL = int(os.getenv("SOAT_UPDATE_INTERVAL", "300"))
...
PRO_PRICE_MONTH = int(os.getenv("PRO_PRICE_MONTH", "29000"))
...
SMS_PAYMENT_MATCH_MIN = int(os.getenv("SMS_PAYMENT_MATCH_MIN", "50"))
SMS_PAYMENT_MATCH_MAX = int(os.getenv("SMS_PAYMENT_MATCH_MAX", "999"))
...
SMS_PAYMENT_TTL_MINUTES = int(os.getenv("SMS_PAYMENT_TTL_MINUTES", "20"))
